...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('localisations', '__first__'),
        ('equipements', '__first__'),
        ('services', '__first__'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorisation', models.CharField(default=b'aut', max_length=3, choices=[(b'bib', 'Biblioth\xe8ques/M\xe9diat\xe8ques'), (b'crd', 'Conservatoires'), (b'sty', 'Sothevy'), (b'aut', 'Autres')])),
