...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Evenement.haut_page'
        db.delete_column('evenements_evenement', 'haut_page')

        # Adding field 'Evenement.page_accueil'
        db.add_column('evenements_evenement', 'page_accueil',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Evenement.complet'
        db.add_column('evenements_evenement', 'complet',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Evenement.haut_page'
        db.add_column('evenements_evenement', 'haut_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Evenement.page_accueil'
        db.delete_column('evenements_evenement', 'page_accueil')

        # Deleting field 'Evenement.complet'
        db.delete_column('evenements_evenement', 'complet')
