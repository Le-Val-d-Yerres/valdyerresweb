...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organisateur.orga_service'
        db.add_column('evenements_organisateur', 'orga_service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Service'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organisateur.orga_equipement'
        db.add_column('evenements_organisateur', 'orga_equipement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipements.Equipement'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organisateur.orga_ville'
        db.add_column('evenements_organisateur', 'orga_ville',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orga_orga_ville', null=True, to=orm['localisations.Ville']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Organisateur.orga_service'
        db.delete_column('evenements_organisateur', 'orga_service_id')

        # Deleting field 'Organisateur.orga_equipement'
        db.delete_column('evenements_organisateur', 'orga_equipement_id')

        # Deleting field 'Organisateur.orga_ville'
        db.delete_column('evenements_organisateur', 'orga_ville_id')
