...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageBase.index_carroussel'
        db.add_column('editorial_pagebase', 'index_carroussel',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageBase.index_carroussel'
        db.delete_column('editorial_pagebase', 'index_carroussel')
    ...
    models = {
        ...
        'editorial.pagebase': {
            ...
            'carrousssel': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
