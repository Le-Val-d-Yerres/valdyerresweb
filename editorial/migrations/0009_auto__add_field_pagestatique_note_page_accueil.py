...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageStatique.note_page_accueil'
        db.add_column('editorial_pagestatique', 'note_page_accueil',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageStatique.note_page_accueil'
        db.delete_column('editorial_pagestatique', 'note_page_accueil')
    ...
    models = {
        ...
        'editorial.pagestatique': {
            ...
            'note_page_accueil': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'pagebase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editorial.PageBase']", 'unique': 'True', 'primary_key': 'True'})
        },
