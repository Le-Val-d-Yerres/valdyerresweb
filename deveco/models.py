...
class Entreprise(models.Model):
    ...
    image = FileBrowseField("Image / Logo de l'entreprise", max_length=200, directory="deveco", extensions=[".jpg", ".png", ".giff", ".jpeg"], blank=True, null=True)
...
class Dirigeant(models.Model):
    ...
    image = FileBrowseField("Photo du dirigeant", max_length=200, directory="deveco/docs", extensions=[".pdf", ".doc", ".odt", ".docx", ".txt"], blank=True, null=True)
    email = models.EmailField(blank=True, null=True)
    presentation = models.TextField(blank=True, null=True)
