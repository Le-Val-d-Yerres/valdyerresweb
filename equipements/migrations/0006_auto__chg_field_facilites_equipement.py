...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facilites.equipement'
        db.alter_column('equipements_facilites', 'equipement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localisations.Lieu']))

    def backwards(self, orm):

        # Changing field 'Facilites.equipement'
        db.alter_column('equipements_facilites', 'equipement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipements.Equipement']))
