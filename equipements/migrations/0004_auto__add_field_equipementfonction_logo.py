...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EquipementFonction.logo'
        db.add_column('equipements_equipementfonction', 'logo',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EquipementFonction.logo'
        db.delete_column('equipements_equipementfonction', 'logo')
