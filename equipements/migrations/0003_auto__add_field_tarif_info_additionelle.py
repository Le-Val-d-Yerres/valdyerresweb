...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tarif.info_additionelle'
        db.add_column('equipements_tarif', 'info_additionelle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tarif.info_additionelle'
        db.delete_column('equipements_tarif', 'info_additionelle')
