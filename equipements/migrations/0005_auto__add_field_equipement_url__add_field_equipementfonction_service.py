...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equipement.url'
        db.add_column('equipements_equipement', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EquipementFonction.service'
        db.add_column('equipements_equipementfonction', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Service'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipement.url'
        db.delete_column('equipements_equipement', 'url')

        # Deleting field 'EquipementFonction.service'
        db.delete_column('equipements_equipementfonction', 'service_id')
